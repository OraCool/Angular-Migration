...
export class StateManager {
  ...
  constructor(checkpointDir?: string) {
    // Use provided checkpointDir or default to home directory
    const defaultDir = path.join(process.env.HOME || process.env.USERPROFILE || '.', '.angular-migration', 'checkpoints');
    this.checkpointDir = checkpointDir || defaultDir;
  }
