<#
.SYNOPSIS
    Fixes Angular 17 breaking changes.
...
Write-Host ""
Write-Host "Applying Angular 17 Breaking Changes Fixes..." -ForegroundColor Cyan
Write-Host ""

$result = Invoke-BreakingChangesFix -ProjectPath $ProjectPath -Version "17"
