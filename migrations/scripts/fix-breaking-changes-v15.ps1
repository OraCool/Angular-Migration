<#
.SYNOPSIS
    Fixes Angular 15 breaking changes.
...
Write-Host ""
Write-Host "Applying Angular 15 Breaking Changes Fixes..." -ForegroundColor Cyan
Write-Host ""

$result = Invoke-BreakingChangesFix -ProjectPath $ProjectPath -Version "15"
