<#
.SYNOPSIS
    Fixes Angular 20 breaking changes.

.PARAMETER ProjectPath
    Path to the Angular project (default: current directory).

.EXAMPLE
    .\fix-breaking-changes-v20.ps1 -ProjectPath "C:\MyProject"
#>
...
Write-Host ""
Write-Host "Applying Angular 20 Breaking Changes Fixes..." -ForegroundColor Cyan
Write-Host ""

$result = Invoke-BreakingChangesFix -ProjectPath $ProjectPath -Version "20"
