<#
.SYNOPSIS
    Migrates Angular project to version 16.

.DESCRIPTION
    Performs complete Angular 16 migration including package updates,
...
.EXAMPLE
    .\migrate-to-v16.ps1 -ProjectPath "C:\MyProject"

.EXAMPLE
    .\migrate-to-v16.ps1 -ProjectPath "C:\MyProject" -AutoCommit -SkipTests

.EXAMPLE
    .\migrate-to-v16.ps1 -ProjectPath "C:\MyProject" -CommitSteps
...
Write-Host "  Angular 16 Migration" -ForegroundColor Cyan
Write-Host "═══════════════════════════════════════════════════════" -ForegroundColor Cyan
Write-Host ""
...
# Confirm migration
Write-WarningMessage "This will migrate your project to Angular 16."
...
try {
    ...
    if ($result.Success) {
        Write-Host ""
        Write-Success "Migration to Angular 16 completed successfully!"
        Write-Host ""
        ...
        Write-InfoMessage "  2. Check migration documentation: migrations/docs/03-migrate-to-angular-16.md"
