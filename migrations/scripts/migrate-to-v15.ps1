<#
.SYNOPSIS
    Migrates Angular project to version 15.

.DESCRIPTION
    Performs complete Angular 15 migration including package updates,
...
.EXAMPLE
    .\migrate-to-v15.ps1 -ProjectPath "C:\MyProject" -AutoCommit -SkipTests

.EXAMPLE
    .\migrate-to-v15.ps1 -ProjectPath "C:\MyProject" -CommitSteps

.EXAMPLE
    .\migrate-to-v15.ps1 -ProjectPath "C:\MyProject" -SkipInstall
...
Write-Host "  Angular 15 Migration" -ForegroundColor Cyan
Write-Host "═══════════════════════════════════════════════════════" -ForegroundColor Cyan
Write-Host ""
...
# Confirm migration
Write-WarningMessage "This will migrate your project to Angular 15."
...
try {
    ...
    if ($result.Success) {
        Write-Host ""
        Write-Success "Migration to Angular 15 completed successfully!"
        Write-Host ""
        ...
        Write-InfoMessage "  3. Commit the changes: git add . && git commit -m 'chore: migrate to Angular 15'"
        Write-Host ""
        Write-InfoMessage "To continue migration:"
        Write-InfoMessage "  .\migrate-to-v16.ps1 -ProjectPath '$ProjectPath'"
        exit 0
    }
    else {
        Write-Host ""
        ...
        Write-InfoMessage "  2. Check migration documentation: migrations/docs/03-migrate-to-angular-15.md"
